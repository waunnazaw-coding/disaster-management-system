...
type SortColumn = 'id' | 'request' | 'disaster' | 'priority' | 'status' | 'assignedAt';
...
export const ReliefAssignmentsTable = ({
  ...
  const sortedAssignments = [...assignments].sort((a, b) => {
    switch (sortConfig.column) {
      ...
      case 'request':
        return sortConfig.direction === 'asc'
          ? a.requestDetails.supportType.localeCompare(b.requestDetails.supportType)
          : b.requestDetails.supportType.localeCompare(a.requestDetails.supportType);
      case 'disaster':
        return sortConfig.direction === 'asc'
          ? a.requestDetails.disasterEventName.localeCompare(b.requestDetails.disasterEventName)
          : b.requestDetails.disasterEventName.localeCompare(a.requestDetails.disasterEventName);
      case 'priority':
            ...
            {sortedAssignments.map((assignment) => (
              <TableRow 
                ...
                className={cn(
                  ...
                  selectedAssignmentId === assignment.id && "bg-blue-50 hover:bg-blue-50"
                )}
                onClick={(e) => {
                  ...
                  <div className="flex items-center justify-end space-x-2">
                    <Button
                      ...
                      className={cn(
                        ...
                        selectedAssignmentId === assignment.id && "text-blue-600 hover:text-blue-700"
                      )}
                    >
