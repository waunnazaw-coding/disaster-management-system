...
// Create a complete tab mapping for all navigation items
const completeTabMap: Record<string, string> = {
  dashboard: "dashboard",
  events: "events",
  ...
  donations: "donations",
  users: "users",
  "relief-team-lists": "teams",
  "financial-admin-invite": "financial-admin-invite",
  "disaster-management-admin-invite": "disaster-admin-invite",
...
function AdminLayout({ children }: { children?: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Use the complete tab mapping
    const newActiveTab = completeTabMap[currentPath] || "dashboard";
