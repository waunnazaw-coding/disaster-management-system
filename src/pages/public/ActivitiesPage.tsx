...
// const ITEMS_PER_PAGE = 9 // Professional grid layout
...
//           <div className="rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl border border-white/20 p-8">
...
//                     handleFilterChange()
//                   }}
//                   className="pl-12 h-14 text-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 rounded-2xl"
//                 />
//               </div>
...
//                   }}
//                 >
//                   <SelectTrigger className="pl-12 h-14 text-lg border-gray-200 focus:border-blue-500 rounded-2xl">
...
//               <Button
//                 variant="outline"
//                 className="h-14 text-lg font-medium border-gray-200 hover:border-blue-500 hover:text-blue-600 hover:bg-blue-50 rounded-2xl transition-all duration-200 bg-transparent"
...
//                     </span>
//                     {searchTerm && (
//                       <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full">Search: "{searchTerm}"</span>
//                     )}
//                     {filterType !== "all" && (
//                       <span className="px-3 py-1 bg-emerald-100 text-emerald-800 rounded-full">Type: {filterType}</span>
//                     )}
//                   </div>
//                 </div>
//               </div>
