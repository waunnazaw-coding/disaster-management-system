...
//                       </div>
//                     </div>
//                     <h1 className="text-4xl font-bold mb-3 leading-tight">{currentActivity.title}</h1>
//                     {currentActivity.reliefTeamName && (
//                       <p className="text-xl text-white/90 font-medium">{currentActivity.reliefTeamName}</p>
//                     )}
//                   </div>
//                   <Button
//                     onClick={onShare}
...
//               {currentActivity.media.length > 0 && (
//                 <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-200">
//                   <h3 className="text-2xl font-bold text-gray-900 mb-6">Activity Gallery</h3>
//                   <div className="grid grid-cols-2 gap-6 md:grid-cols-3">
//                     {currentActivity.media.map((m, idx) => (
//                       <button
//                         key={m.id}
...
//               {/* Key Stats */}
//               <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-200 space-y-6">
//                 <h3 className="text-xl font-bold text-gray-900 mb-6">Activity Details</h3>
...
//                 </p>
//                 <Button
//                   className="w-full bg-white text-red-600 hover:bg-red-50 font-semibold py-3 rounded-2xl transition-all duration-200"
//                   onClick={() => navigate("/get-involved")}
//                 >
//                   Learn More
//                 </Button>
