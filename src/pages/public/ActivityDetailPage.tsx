...
// // Lightbox imports (keeping your existing setup)
...
//   // Build lightbox slides (keeping your existing logic)
...
//         <Button
//           variant="ghost"
//           className="mb-8 text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-2xl px-6 py-3 font-medium"
//           onClick={() => navigate(-1)}
//         >
...
//               {/* Items Distributed */}
//               {currentActivity.itemsDistributed && (
//                 <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-white/20">
...
//                     </h3>
//                   </div>
//                   <p className="text-gray-700 text-lg leading-relaxed bg-amber-50 p-6 rounded-2xl border border-amber-100">
//                     {currentActivity.itemsDistributed}
//                   </p>
//                 </div>
//               )}
...
//                               preload="metadata"
//                             />
//                             <div className="absolute inset-0 flex items-center justify-center bg-black/40 opacity-100 transition-opacity group-hover:opacity-80">
...
//                         </h4>
//                         <p className="text-gray-600">
//                           {currentActivity.peopleHelped.toLocaleString()}{" "}
//                           individuals
//                         </p>
//                       </div>
//                     </div>
...
//                         </h4>
//                         <p className="text-gray-600">
//                           ${currentActivity.expenseAmount.toLocaleString()}{" "}
//                           invested
//                         </p>
//                       </div>
//                     </div>
