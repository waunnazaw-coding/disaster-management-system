...
import {
  Heart, Shield, Users, Truck, Home, BookOpen, DollarSign, Smartphone, User, Building2, FileText
} from "lucide-react"
import {
...
const sourceTypes = [
  ...
  { value: "Organization", label: "Organization", icon: <Building2 className="h-4 w-4" />, description: "Non-profit organization" },
...
const paymentMethods = [
  {
    ...
    qrCodeUrl: "https://images.pexels.com/photos/7130542/pexels-photo-7130542.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  },
  {
    id: "wavepay",
    name: "Wave Pay",
    ...
    qrCodeUrl: "https://images.pexels.com/photos/7130467/pexels-photo-7130467.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  },
  {
    id: "ayapay",
    name: "Aya Pay",
    ...
    qrCodeUrl: "https://images.pexels.com/photos/7130560/pexels-photo-7130560.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  },
  {
    id: "uabpay",
    name: "UAB Pay",
    ...
    qrCodeUrl: "https://images.pexels.com/photos/7130545/pexels-photo-7130545.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  },
]
...
const donationSchema = z.object({
  ...
  sourceType: z.enum(sourceTypes.map(st => st.value) as [string, ...string[]], {
...
export default function DonationPage() {
  ...
  const handleCategoryClick = (index: number) => {
    ...
    setValue("selectedCategory", newValue === null ? undefined : newValue, { shouldValidate: true })
  }
  const handleAmountClick = (amount: number) => {
    const newValue = amount === selectedAmount ? null : amount
    setSelectedAmount(newValue)
    setValue("selectedAmount", newValue === null ? undefined : newValue, { shouldValidate: true })
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Your donation helps us protect communities across Myanmar. Every contribution, no matter the size, makes a real difference in saving lives and building resilience.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <Card className="border-0 shadow-lg text-center">
            <CardContent className="p-6">
              ...
              <div className="text-sm text-gray-600">Total Raised This Year</div>
            </CardContent>
          </Card>
          <Card className="border-0 shadow-lg text-center">
            <CardContent className="p-6">
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>Choose your donation amount and help us continue our vital work.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  {/* Donation Categories */}
                  <div>
                    <Label className="text-base font-medium mb-4 block">Choose a Category</Label>
                        ...
                        return (
                          <Card
                            ...
                            className={`border-2 cursor-pointer transition-all duration-200 hover:shadow-md ${
                              selected ? "border-red-500 bg-red-50 shadow-md" : "border-gray-200 hover:border-red-300"
                            }`}
                          ...
                          >
                            <CardContent className="p-4">
                              <div className="flex items-start gap-3">
                                <div
                                  className={`p-2 rounded-lg ${category.color.replace("text-", "bg-").replace("-800", "-100")}`}
                                >
                                  {category.icon}
                                </div>
                                <div className="flex-1">
                                  ...
                                  {selected && <div className="text-xs text-green-600 font-medium">✓ Selected</div>}
                                </div>
                              </div>
                            </CardContent>
                          </Card>
                    ...
                    {errors.selectedCategory && (
                      <p className="text-xs text-red-600 mt-1">{errors.selectedCategory.message}</p>
                    )}
                  </div>

                  {/* Donation Amounts */}
                  <div>
                    <Label className="text-base font-medium mb-4 block">Select Amount (MMK)</Label>
                        ...
                        return (
                          ...
                          >
                            <CardContent className="p-4 text-center">
                              ...
                              {selected && <div className="text-xs text-green-600 font-medium mt-2">✓ Selected</div>}
                            </CardContent>
                          </Card>
                        )
                      })}
                    ...
                    <div className="space-y-2">
                      ...
                      {errors.selectedAmount && (
                        <p className="text-xs text-red-600 mt-1">{errors.selectedAmount.message}</p>
                      )}
                    </div>
                  </div>
                            ...
                            <CardContent className="p-4">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg p-4 mt-4 animate-in slide-in-from-top-2 duration-200">
                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                                        <div className="space-y-2">
                                          ...
                                          <div className="bg-yellow-50 border border-yellow-200 rounded p-2 mt-3">
                                            <p className="text-xs text-yellow-800">
                                              💡 Please include your name in the transfer description for proper receipt processing.
                                            </p>
                                          </div>
                                        </div>
                                        <div className="flex flex-col items-center">
                                          ...
                                          />
                                          <p className="text-xs text-gray-500 mt-2 text-center">Scan QR code to pay</p>
                                        </div>
                                      </div>
                                    </div>
                                  )}
                                  ...
                                  {!selected && (
                                    <p className="text-xs text-gray-500 mt-1">Click to view account details</p>
                                  )}
                                  {errors.selectedPaymentMethod && selected && (
                                    <p className="text-xs text-red-600 mt-1">{errors.selectedPaymentMethod.message}</p>
                                  )}
                                </div>
                              </div>
                            </CardContent>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      />
                      {errors.sourceType && (
                        <p className="text-xs text-red-600 mt-1">{errors.sourceType.message}</p>
                      )}
                    </div>
                    <div className="space-y-2">
            ...
            <div className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">MMK 25,000 • 2 hours ago</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">Thant Zin</p>
                      <p className="text-sm text-gray-600">MMK 10,000 • 5 hours ago</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">Khin Mar</p>
                      <p className="text-sm text-gray-600">MMK 15,000 • 1 day ago</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent>
                  <p className="text-sm text-gray-600 mb-4">Have questions about donating? Our team is here to help.</p>
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">How Your Money Helps</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-0 shadow-lg text-center">
              <CardContent className="p-8">
                ...
                <p className="text-sm text-gray-600">Emergency supplies for one family for one week</p>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-lg text-center">
              <CardContent className="p-8">
                ...
                <p className="text-sm text-gray-600">Training materials for 10 community volunteers</p>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-lg text-center">
              <CardContent className="p-8">
                ...
                <p className="text-sm text-gray-600">Relief supplies delivery to remote areas</p>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-lg text-center">
              <CardContent className="p-8">
                ...
                <p className="text-sm text-gray-600">Temporary shelter for displaced families</p>
              </CardContent>
            </Card>
          </div>
        </div>
