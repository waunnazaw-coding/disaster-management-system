      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center h-20 flex-wrap gap-4">
          ...
          <div className="flex gap-3">
            <Button
              className="bg-indigo-600 h-11 rounded-md shadow-sm text-sm font-medium text-white hover:bg-indigo-700"
        ...
        <div className="flex flex-wrap gap-4 items-center mt-6 mb-8">
          <input
            ...
            className="border-2 px-3 py-2 rounded-lg text-sm flex-1 min-w-[200px] active:border-black"
          />

          <select
            value={typeFilter}
            onChange={(e) => setTypeFilter(e.target.value)}
            className="border-2 px-3 py-2 rounded-lg text-sm focus:border-black"
          >
          ...
          <select
            value={statusFilter}
            onChange={(e) => setStatusFilter(e.target.value)} // 👈 new status filter
            className="border-2 px-3 py-2 rounded-lg text-sm focus:border-black"
          >
