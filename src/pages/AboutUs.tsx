...
import { Shield, Users, Heart, Target, Eye, Handshake } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          {[
            {
              title: "Our Mission",
              desc: "To build resilient communities across Myanmar by providing comprehensive disaster management services, emergency response coordination, and community-based preparedness programs that save lives and reduce suffering.",
              icon: <Target className="h-8 w-8 text-red-600" />,
              bg: "bg-red-100",
            },
            {
              title: "Our Vision",
              desc: "A Myanmar where every community is prepared, protected, and resilient against disasters, with the knowledge and resources needed to respond effectively to emergencies and recover quickly.",
            ...
            >
              <CardHeader className="text-center pb-6">
                <div
                  className={`mx-auto h-16 w-16 ${item.bg} rounded-full flex items-center justify-center mb-4`}
                >
                  {item.icon}
                </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
              ...
              <p>
                ...
                management ecosystem that protects lives and livelihoods across
                Myanmar.
              </p>
            </div>
          </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We collaborate with trusted organizations and stakeholders who share
              our commitment to building resilient communities and safeguarding
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-8 text-white text-center">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-3xl mx-auto">
            Help us build a more resilient Myanmar. Whether through volunteering,
            partnerships, or community engagement, there are many ways to get
            involved.
          </p>
